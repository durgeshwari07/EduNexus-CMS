...
const GatewayView = ({ 
  ...
  return (
    <div className="app-layout w-full text-left flex h-screen overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <Header userRole={userRole} currentUser={currentUser} />

        {/* MAIN SCROLLABLE CONTENT */}
        <main className="main-content flex-1 overflow-y-auto custom-scrollbar p-8">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="flex bg-white p-1 rounded-xl border border-slate-200 shadow-sm">
                  <select 
                    value={activeFilter} 
                    onChange={(e) => setActiveFilter(e.target.value)}
                    className="bg-transparent px-3 py-1.5 text-[11px] font-black text-slate-600 outline-none cursor-pointer appearance-none pr-8 relative bg-no-repeat"
                    style={{ 
