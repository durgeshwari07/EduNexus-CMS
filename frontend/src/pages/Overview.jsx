...
//                     {t.name}
//                   </span>
//                   <span className="text-[10px] text-slate-400 font-bold italic">Verification Required</span>
//                 </div>
//               </td>
//               <td className="px-6 py-4">
//                 <span className="text-slate-500 font-black text-[10px] uppercase bg-slate-100 px-2 py-1 rounded">
//                    {t.dept || 'Unassigned'}
//                 </span>
//               </td>
//               <td className="px-6 py-4 text-slate-400 text-[10px] font-bold uppercase tracking-tight">
//                 {/* Format Date from MySQL */}
//                 {new Date(t.dateApplied).toLocaleDateString('en-US', { 
...
//                       Approve
//                     </button>
//                     <button className="text-slate-300 font-black text-[9px] uppercase tracking-widest hover:text-red-500 transition">
//                       Reject
//                     </button>
//                   </div>
//                 )}
...
//                   <p className="italic text-xs font-black uppercase tracking-widest">Everything up to date</p>
//                </div>
//             </td>
//           </tr>
//         )}
    ...
    <div className="animate-in fade-in duration-500 max-w-full font-sans p-2">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium tracking-tight">
            Welcome back, {isAdmin ? 'Admin' : 'Faculty'}. Here is the system snapshot for today.
          </p>
        </div>
        <div className="flex gap-3">
           <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 px-4 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm">
      ...
      {/* 2. KPI STATS */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatCard icon={<Building2/>} label="Total Departments" value={departments.length} trend="+0 New" color="text-emerald-500" />
        <StatCard icon={<Users/>} label="Approved Teachers" value={teachers.length} trend="Active" color="text-slate-400" />
        <StatCard icon={<GraduationCap/>} label="Students" value="1,200" trend="+12%" color="text-emerald-500" />
        <StatCard icon={<BookOpen/>} label="Subjects" value="32" trend="Semester 1" color="text-slate-400" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <td className="px-6 py-4 flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-[10px] text-slate-400 font-bold flex items-center gap-1">
                              <Clock size={10} /> Verification Required
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <span className="text-slate-500 font-black text-[10px] uppercase bg-slate-100 px-2 py-1 rounded">
                             {t.deptName || t.dept || 'Unassigned'}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-slate-400 text-[10px] font-bold uppercase tracking-tight">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-[24px] border border-slate-200 p-7 shadow-sm">
            ...
            <div className="space-y-5">
               <CalendarItem day="24" month="FEB" title="Midterm Exams" sub="All Departments" active />
               <CalendarItem day="28" month="FEB" title="Staff Meeting" sub="Main Conference Hall" />
               <CalendarItem day="02" month="MAR" title="Cultural Fest" sub="Campus Grounds" />
            </div>
            <button className="w-full mt-8 py-3.5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 border border-slate-100 rounded-xl hover:bg-slate-50 hover:text-[#136dec] transition-all">Full Schedule</button>
          </div>
